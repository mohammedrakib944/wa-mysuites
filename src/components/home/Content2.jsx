...
const Content2 = () => {
  return (
    <motion.div
      ...
      className="bg-[#292929] pt-6 lg:pt-20"
    >
      ...
      <Marquee pauseOnHover={true} speed={50} gradient={false}>
        <div className="grid gap-3 md:gap-6 ml-6 md:grid-cols-3 pb-10">
      ...
      <div className="pt-24 pb-40">
        <button className="mx-auto uppercase w-fit max-h-[60px] text-[14px] md:text-[16px] py-4 px-7 bg-transparent hover:bg-gray-100 hover:text-gray-800 border text-white font-normal">
